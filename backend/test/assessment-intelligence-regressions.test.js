...
test('assessment intelligence migration is additive governed and registered', () => {
  ...
  assert.equal(expected.at(-20), '20260727120000_assessment_intelligence');
  assert.equal(expected.at(-19), '20260729100000_secure_browser_sessions');
  assert.equal(expected.at(-18), '20260729140000_mobile_accessibility_offline');
