...
test('assessment intelligence migration is additive governed and registered', () => {
  ...
  assert.equal(expected.at(-13), '20260727120000_assessment_intelligence');
  assert.equal(expected.at(-12), '20260729100000_secure_browser_sessions');
  assert.equal(expected.at(-11), '20260729140000_mobile_accessibility_offline');
